# -*- encoding: utf-8 -*-
# stub: json-schema 6.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<minitest>.freeze, [">= 5.0".freeze, "< 7".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.0".freeze])
  s.add_development_dependency(%q<voxpupuli-rubocop>.freeze, ["~> 5.1.0".freeze])
